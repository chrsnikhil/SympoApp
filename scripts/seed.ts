  ...
  await challenges.insertMany([
    ...
    // ── EASY 1: Web of Secrets ─────────────────────────────────────────────
    {
      ...
      config: {
        ...
        hints: [
          ...
          { id: 3, text: "A shift of 16 (from 1610) will turn the ciphertext back into readable English.", unlockSeconds: 900 },
        ],
        status: "open",
        attachments: [],
      },
    ...
    // ── EASY 2: The Spot's Broken Portal ──────────────────────────────────
    {
      ...
      config: {
        ...
        hints: [
          ...
          { id: 3, text: " Write a short script that generates candidates matching the pattern and compares MD5 hashes, or use the narrative clue to reduce the search.", unlockSeconds: 900 },
        ],
        status: "open",
        attachments: [],
      },
    ...
    // ── MEDIUM 1: Spot Maze ────────────────────────────────────────────────
    {
      ...
      config: {
        ...
        status: "open",
        attachments: ["medium-01-spot-maze.png"],
      },
    },
