...
export default function CoordinatorDashboard() {
  const [authToken, setAuthToken] = useState(() => sessionStorage.getItem('coord_token') || '');
  ...
  async function handleAuthSubmit(e) {
    ...
    // against VITE_COORDINATOR_PASSWORD env var
    ...
    if (edgeFunctionDown) {
      const envPassword = import.meta.env.VITE_COORDINATOR_PASSWORD || 'kenrich@202';
  ...
  return (
    <div className="min-h-screen bg-[#141313] text-[#e5e2e1] font-['Courier_Prime'] flex flex-col justify-between relative">
      ...
      {/* Header */}
      <header className="fixed top-0 w-full z-40 flex justify-between items-center px-6 py-4 border-b-4 border-[#ffffff] border-dashed bg-[#141313]/90 backdrop-blur-md">
