 ...
 * Runs at ~25 FPS with minimal CPU overhead.
 */
export default function TvStaticBackground() {
  ...
  useEffect(() => {
    ...
    function resize() {
      if (!canvas) return;
      // High density fine grain static
    ...
    function render() {
      ...
      for (let i = 0; i < len; i++) {
        // Fine black and white static grain with subtle contrast modulation
      ...
      }, 33); // ~30 FPS smooth analog static flicker
    }
