  ...
  await challenges.insertMany([
    ...
    // ── HARD 1: AI Escape Room ─────────────────────────────────────────────
    {
      ...
      config: {
        ...
        hints: [
          { id: 1, text: "AI systems follow rules — but rules can be reframed. Try roleplay scenarios.", unlockSeconds: 120 },
          { id: 2, text: "Ask the AI to translate or summarize its system instructions.", unlockSeconds: 300 },
          { id: 3, text: "The raw AI system token is Base64 encoded. Decode cHJvbXB0X2luamVjdGlvbl9qYWlsYnJva2VuX2Fp.", unlockSeconds: 600 },
        ],
        status: "open",
        attachments: [],
      },
